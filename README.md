...
## Known Bugs
* In Linux / OS X; the maximize/restore header button does not update the simulation display field. It's recommended to use the setting tab's fullscreen/window button to change the resolution.
