...
def readTOML_sim_names():
    with open(r'gameoflife\data\structures.toml', 'r') as f:
...
def readTOML_all_themes_name():
    with open(r'gameoflife\data\themes.toml', 'r') as f:
...
def readTOML_all_graphics_name():
    with open(r'gameoflife\data\graphics.toml', 'r') as f:
...
def readTOML_all_resolutions_name():
    with open(r'gameoflife\data\resolutions.toml', 'r') as f:
...
def readTOML_default(arguement):
    with open(r'gameoflife\data\default.toml', 'r') as f:
        default = toml.load(f)
...
def writeTOML_default(themes, graphics, resolution, framerate):
    ...
    with open(r'gameoflife\data\default.toml', 'w') as f:
        toml.dump(default, f)
